		...
		<section id="#" class="two">
			<div class="container-b">
				...
				<div class="row">
					...
					<div class="col-4 col-12-mobile">
						<article class="item">
							<a href="BoardDetail.jsp?num=<%=board_list.get(11).getB_seq()%>" class="image fit"><img alt="" src="<%= "./upload/"+ board_list.get(10).getB_file() %>" /></a>
						
						</article>
						<article class="item">
							<a href="BoardDetail.jsp?num=<%=board_list.get(15).getB_seq()%>" class="image fit"><img alt="" src="<%= "./upload/"+ board_list.get(11).getB_file() %>" /></a>
						</article>
					</div>
